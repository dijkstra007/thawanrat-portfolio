...
export const homepageCopy: Localized<HomepageCopy> = {
  en: {
    hero: {
      ...
      alt: 'A studio mockup with a ChaiLai bag, colorful Phop Pra snack packaging, a Protech brochure, a Mango Smith card, beverage packaging, and a digital campaign on a tablet',
    },
  ...
  th: {
    hero: {
      ...
      alt: 'ภาพจำลองถุง ChaiLai บรรจุภัณฑ์ขนมพบประสีสด โบรชัวร์ Protech การ์ด Mango Smith บรรจุภัณฑ์เครื่องดื่ม และสื่อดิจิทัลบนแท็บเล็ต',
    },
