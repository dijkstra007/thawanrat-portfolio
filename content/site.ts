...
export const site = {
  ...
  copy: {
    en: {
      metadata: {
        title: 'Thawanrat T. | Graphic Designer for Brand, Print & Digital (Bangkok)',
        description:
      ...
      caseStudy: {
        ...
        categoryLabels: {
          ...
          Campaign: 'PRINT & EVENT',
          Branding: 'BRAND IDENTITY',
          Digital: 'SOCIAL & DIGITAL',
        },
      },
      workMenu: {
        ...
        awards: [
          ...
          { label: 'New Member Card & Benefits', id: 26 },
        ],
      },
    },
    th: {
      metadata: {
        title: 'Thawanrat T. | กราฟิกดีไซเนอร์ งานแบรนด์ สิ่งพิมพ์ และสื่อออนไลน์',
      ...
      hero: {
        ...
        intro:
          'สร้างงานออกแบบที่ใส่ใจในรายละเอียด ครอบคลุมทั้งบรรจุ\u2060ภัณฑ์ งานพิมพ์ และสื่อดิจิทัล',
        workCta: 'ดูผลงาน',
      ...
      about: {
        ...
        body:
          'มีความเชี่ยวชาญด้านกราฟิกดีไซน์ โดยเน้นงานบรรจุ\u2060ภัณฑ์ การสื่อสารแบรนด์ และอาร์ตเวิร์กสำหรับสื่อสิ่งพิมพ์และดิจิทัล ดูแลตั้งแต่เริ่มต้นจนพร้อมนำไปใช้จริง',
        imageAlt: 'ธวัลรัตน์กำลังยิ้มในคาเฟ่',
        yearsValue: '3+',
      ...
      caseStudy: {
        ...
        categoryLabels: {
          ...
          Campaign: 'สิ่งพิมพ์และอีเวนต์',
          Branding: 'แบรนดิ้ง',
          Digital: 'โซเชียลและดิจิทัล',
        },
      },
      workMenu: {
        ...
        awards: [
          ...
          { label: 'บัตรสมาชิกใหม่และสิทธิพิเศษ', id: 26 },
        ],
      },
    },
