    ...
    <>
      <section className={styles.hero} id="top" aria-labelledby="hero-title">
        ...
        <figure className={styles.art}>
          <img className={styles.scene} src={assetPath('/images/fahworks-hero-still-life-v2.webp')} alt={hero.alt} width={1536} height={1024} fetchPriority="high" loading="eager" draggable={false} />
